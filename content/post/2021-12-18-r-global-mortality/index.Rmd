...
theme_update(axis.title.x = element_text(color = "grey30", size = 9, margin = margin(15,0,0,0)),
             axis.text.x = element_text(color = "grey30", size = 9, margin = margin(10,0,0,0)),
             axis.ticks.x = element_line(),
             axis.title.y = element_blank(),
             axis.text.y = element_text(color = "grey30", size = 9, hjust = 1),
...
fundo <- ggplot() +
  ...
  theme(plot.background = element_rect(fill = "#E8E8E8", color = NA),
        plot.title = element_text(family = "oswald", color = "#737373", face = "bold", size = 20),
        plot.subtitle = element_textbox(family ="roboto", color = "#737373", size = 14))

final <- ggdraw(fundo) + 
  draw_plot(plot_br, width = 0.75, height = 0.85, y = 0.05, x = 0.15) +
  draw_text(x = 0.45, y = 0.01, 
            text = "Author: Gustavo H. Migliorini | Data: Global mortality", 
            family = "techmono", size = 8, color = "grey30", hjust = 1)

```


```{r}
ragg::agg_png(here::here("plots", paste("mortality", ".png")), res = 320, width = 8, height = 6, units = "in")
